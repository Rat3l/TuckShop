...
<body id="ReportBody">
    ...
    <input onclick="handleRadioClick()" type="radio" id="AllReports" name="ReportSelector" value="AllReports" required>
	<label  for="AllReports">All Time</label><br>
	...
	<input type="button" value="Copy" id="copyButton" onclick="copyTable(document.getElementById('ReportTable'))" style="display:none;">
	<div id="result"></div>
