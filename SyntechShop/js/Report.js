    const MonthSelectorElement = document.getElementById('monthSelector');
 	...
 	function Submit()
 	{
    	...
    	if (document.getElementById('AllReports').checked)
    	{
    		var bool = true;
			postAll(bool);
 	...
 	function postMonth(Year,Month,bool)
    {
        ...
        $.post('PostReport.php', {postYear:PostYear,postMonth:PostMonth,postShowAll:ShowAll},
            function(data)
            {
                $('#result').html(data);    
            }
    ...
    function postAll(bool)
    {
        ...
        $.post('PostReport.php', {postShowAll:doAll},
            function(data)
            {
                $('#result').html(data);     
            }
 	...
 	function postDay(Year,Month,Day,bool)
    {
        ...
        $.post('PostReport.php', {postYear:Year,postMonth:Month,postDay:Day,postShowAll:bool},
            function(data)
            {
                $('#result').html(data);            
            }
    ...
    function postUser(User, bool)
    {
        ...
        $.post('PostReport.php', {postUser:User,postShowAll:bool},
            function(data)
            {
                $('#result').html(data);            
            }
